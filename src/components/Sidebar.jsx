...
const Sidebar = ({ activeView, onNavigate, isAdminMode }) => {
    return (
        <aside className="sidebar">
            ...
            <nav className="sidebar-nav">
                {!isAdminMode ? (
                    ...
                    <>
                        <div
                            className={`nav-item ${activeView === 'admin-users' ? 'active' : ''}`}
                        ...
                        <div
                            className={`nav-item ${activeView === 'admin-calendar' ? 'active' : ''}`}
                        ...
                        <div
                            className={`nav-item ${activeView === 'admin-appointments' ? 'active' : ''}`}
